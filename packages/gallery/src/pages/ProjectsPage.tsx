  ...
  return (
    <div className="min-h-screen bg-bg">
      <header className="border-b border-border px-8 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-faint hover:text-accent transition-colors uppercase tracking-widest"
          >
      ...
      <main className="px-8 py-12 max-w-wrap mx-auto">
        <div className="mb-10">
          <p className="text-xs text-accent font-semibold tracking-widest uppercase mb-2">Mes galeries</p>
...
const ProjectCard = ({ project }: { project: Project }) => (
  <Link
    ...
    className="group bg-surface border border-border hover:border-accent/40 transition-colors p-6 flex flex-col gap-4"
  >
